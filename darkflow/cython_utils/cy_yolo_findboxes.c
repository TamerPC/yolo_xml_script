 ...
 */
      __pyx_t_18 = __pyx_v_grid;
      __pyx_t_17 = __pyx_v_b;
      __pyx_t_16 = 1;
      __pyx_t_21 = __pyx_v_grid;
      __pyx_t_20 = __pyx_v_b;
      __pyx_t_19 = 1;
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_21 * __pyx_v_coords.strides[0]) ) + __pyx_t_20 * __pyx_v_coords.strides[1]) )) + __pyx_t_19)) )) = (((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_18 * __pyx_v_coords.strides[0]) ) + __pyx_t_17 * __pyx_v_coords.strides[1]) )) + __pyx_t_16)) ))) + (__pyx_v_grid / __pyx_v_S)) / __pyx_v_S);
 ...
 */
      ...
      __pyx_t_20 = __pyx_v_b;
      __pyx_t_21 = 2;
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_19 * __pyx_v_coords.strides[0]) ) + __pyx_t_20 * __pyx_v_coords.strides[1]) )) + __pyx_t_21)) )) = powf((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_16 * __pyx_v_coords.strides[0]) ) + __pyx_t_17 * __pyx_v_coords.strides[1]) )) + __pyx_t_18)) ))), __pyx_v_sqrt);
 ...
 */
      ...
      __pyx_t_20 = __pyx_v_b;
      __pyx_t_19 = 3;
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_21 * __pyx_v_coords.strides[0]) ) + __pyx_t_20 * __pyx_v_coords.strides[1]) )) + __pyx_t_19)) )) = powf((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_18 * __pyx_v_coords.strides[0]) ) + __pyx_t_17 * __pyx_v_coords.strides[1]) )) + __pyx_t_16)) ))), __pyx_v_sqrt);
 ...
 */
        __pyx_t_16 = __pyx_v_grid;
        __pyx_t_17 = __pyx_v_class_loop;
        __pyx_t_18 = __pyx_v_grid;
        __pyx_t_19 = __pyx_v_b;
        __pyx_t_20 = __pyx_v_grid;
        __pyx_t_21 = __pyx_v_class_loop;
        *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_20 * __pyx_v_probs.strides[0]) )) + __pyx_t_21)) )) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_16 * __pyx_v_probs.strides[0]) )) + __pyx_t_17)) ))) * (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_confs.data + __pyx_t_18 * __pyx_v_confs.strides[0]) )) + __pyx_t_19)) ))));
 ...
 */
        __pyx_t_19 = __pyx_v_grid;
        __pyx_t_18 = __pyx_v_class_loop;
        __pyx_t_25 = (((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_19 * __pyx_v_probs.strides[0]) )) + __pyx_t_18)) ))) > __pyx_v_threshold) != 0);
        if (__pyx_t_25) {
 ...
 */
          __pyx_t_18 = __pyx_v_grid;
          __pyx_t_19 = __pyx_v_class_loop;
          __pyx_t_17 = __pyx_v_grid;
          __pyx_t_16 = __pyx_v_b;
          __pyx_t_21 = __pyx_v_class_loop;
          *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_final_probs.data + __pyx_t_17 * __pyx_v_final_probs.strides[0]) ) + __pyx_t_16 * __pyx_v_final_probs.strides[1]) )) + __pyx_t_21)) )) = (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_18 * __pyx_v_probs.strides[0]) )) + __pyx_t_19)) )));
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_26 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_26.memview)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_f_8darkflow_12cython_utils_3nms_NMS(__pyx_t_10, __pyx_t_26); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     cdef:
 */
  __pyx_tuple__22 = PyTuple_Pack(18, __pyx_n_s_meta, __pyx_n_s_net_out, __pyx_n_s_threshold, __pyx_n_s_sqrt, __pyx_n_s_C, __pyx_n_s_B, __pyx_n_s_S, __pyx_n_s_SS, __pyx_n_s_prob_size, __pyx_n_s_conf_size, __pyx_n_s_grid, __pyx_n_s_b, __pyx_n_s_class_loop, __pyx_n_s_boxes, __pyx_n_s_probs, __pyx_n_s_confs, __pyx_n_s_coords, __pyx_n_s_final_probs); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(3, 0, 18, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_darkflow_cython_utils_cy_yolo_fi, __pyx_n_s_yolo_box_constructor, 14, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__26, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 289, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__28, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 293, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
